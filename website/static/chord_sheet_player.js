...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!display || !SONG_DATA.sheetData) {
    ...
    function renderChordSheet(steps, lyricsOnly = false) { 
        ...
        if (!CS?.ChordProParser) {
            display.innerHTML = '<p style="color: #999;">ChordSheetPro JS Not Loaded.</p>';
            return;
        }
        ...
        try {
            ...
            display.innerHTML = '<p style="color: #999;">Error rendering chord sheet</p>';
        }
    }
